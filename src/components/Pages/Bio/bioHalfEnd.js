  ...
  return (
    ...
    >
      <div className={styles.leftContent}>
        <p>
          <strong>Parallèlement à son travail personnel,</strong> Eric Fayolle
          exerce aussi une activité de design graphique auprès d’institutions
          culturelles, identité visuelle et communication événementielle, et de
          cabinets d’architectes, mise en couleur de bâtiments, signalétique,
          design architectural et de création de timbres pour La Poste
        </p>
        <div className={styles.containerImg}>
          <div className={styles.cardImg}>
            <img
              src="../../images/bio/sectionbottom01.jpg"
              alt="Affiche de pub réalisés par Éric Fayolle"
            />
          </div>
          <div className={styles.cardImg}>
            <img
              src="../../images/bio/sectionbottom02.jpg"
              alt="Affiche de pub réalisés par Éric Fayolle"
            />
          </div>
        </div>
      ...
      <div className={styles.rightContent}>
        <img
          src="../../images/bio/sectionbottom03.jpg"
          alt="Affiche de pub réalisés par Éric Fayolle"
        />
      </div>
    </motion.div>
