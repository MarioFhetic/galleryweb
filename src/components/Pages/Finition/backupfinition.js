      ...
      <ParallaxLayer offset={0}>
        <div className={styles.bigContainer}>
          ...
          <div className={styles.section}>
            <div className={styles.leftContent}>
              <p>
                ...
                l'image, sur laquelle est collé au dos un châssis en aluminium
                de 2 cm d'épaisseur, rentrant de 5 cm.
              </p>
          ...
          <div className={styles.infoSection}>
            <p>
              Cette finition garantie une excellente rigidité et permet une
