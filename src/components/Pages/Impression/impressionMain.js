  ...
  return (
    ...
    >
      <div className={styles.leftContent}>
        ...
        <p>
          L'Atelier Label Image est un laboratoire photographique artisanal de
          tirages numériques.
        </p>
        <p>
          J’y ai rencontré des professionnels aiguisés, sensibles à toutes les
          nuances d’une image, à l’équilibre des contrastes, la qualité des
          noirs, leur épaisseur et leur transparence. Je retrouve dans cet
          atelier la même exigence dans le réglage des impressions numériques
          que celles que j’imposais à mes tirages argentiques
        </p>
        <p>
          Mon partenariat avec Label Image me permet donc d’échanger et de faire
          des choix créatifs jusqu’au tirage définitif de l’image, comme je le
          faisais dans la solitude de mon laboratoire mais avec le plaisir de
          les avoir partagés.
        </p>
      </div>
